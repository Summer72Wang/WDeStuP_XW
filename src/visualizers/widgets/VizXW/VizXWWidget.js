...
define(["jointjs", "css!./styles/MyVizWidget.css"], function (joint) {
    "use strict";
    var WIDGET_CLASS = "my-viz";
    ...
    VizXWWidget.prototype.onActivate = function () {
      this._logger.debug("MyVizWidget has been activated");
    };
  
    VizXWWidget.prototype.onDeactivate = function () {
      this._logger.debug("MyVizWidget has been deactivated");
    };
